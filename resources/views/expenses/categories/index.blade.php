...
<div class="wrapper sidebar_minimize">
    ...
    <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            <div class="page-header">
              <h3 class="fw-bold mb-3">Categoría de gastos</h3>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="categories-container">
                      ...
                      >
                        ...
                        <tbody>
                            @include('expenses.categories.partials.list')
                        </tbody>
                      </table>
                    </div>
                  </div>
        ...
        @include('expenses.categories.create')
        @include('expenses.categories.edit')
...
<script>
    ...
    function loadCategories() {
        showLoader();
        $.ajax({
            url: "{{ route('expensescat.list') }}",
            type: "GET",
            success: function(data) {
                $("#categories-container tbody").html(data);
            },
            error: function() {
                console.error("Error al cargar categoría de gastos");
            },
            complete: function() {
                hideLoader();
            }
...
<script>
    $(document).ready(function(){
        $(document).on("click", ".category-eliminar", function(e){
            ...
            Swal.fire({
                title: "Eliminacion de categoría de gasto",
                text: "Estás seguro de eliminar la categoría de gasto: " + name + "?",
                icon: "warning",
